...
class AssociationRuleMiner:
    ...
    provided by Christian Borgelt's PyFIM library available at
    ...
    def mine_assoc_rules(self, min_support=0.1, min_confidence=0.8,
        ...
        Arguments:
            ...
            min_confidence: Minimum confidence of the association rule in [0,1]
                (default: 0.8).
            algorithm: Algorithm used for frequent item set mining.
